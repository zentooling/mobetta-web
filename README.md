...
See [GoDoc](https://godoc.org/github.com/zentooling/golang-web-server) for further documentation.

## Contributions

Contributions are welcome and greatly appreciated. Please note that I am not looking to add any more features to this project but I am happy to take care of bugfixes, updates and other suggestions. If you have a question or suggestion please feel free to [open an issue](https://github.com/zentooling/golang-web-server). To contribute code, please fork this repository, make your changes on a separate branch and then [open a pull request](https://github.com/zentooling/golang-base-project/compare).

For security related issues please see my profile, [@zentooling](https://github.com/zentooling), for ways of contacting me privately. 
